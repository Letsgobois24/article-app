<aside id="default-sidebar"
    class="fixed top-0 left-0 w-64 z-40 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidenav">
    <div class="overflow-y-auto px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="h-nav flex justify-between items-center">
            <div class="p-2 text-gray-900 font-bold text-2xl">Artikelku</div>
